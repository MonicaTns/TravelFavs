...
import com.tanase.travelfavs.databinding.FragmentEditMmeoryBinding
import com.tanase.travelfavs.domain.Memory


class EditMemoryFragment : Fragment() {

    private var _binding: FragmentEditMmeoryBinding?=null
    private val binding get() = _binding!!

    private val viewModel: EditMemoryFragmentViewModel by viewModels {
        EditMemoryFragmentViewModel.provideFactory((activity?.application as TravelFavsApplication).memoriesRepository)
    }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditMmeoryBinding.inflate(inflater, container, false)
        return binding.root
    }
